    ...
    <div id="analysis-component">
        <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
            <div class="row" style="position: relative;">
                <div class="col-6">
                    <export-excel-button :filter_period="filter_period"></export-excel-button>
                </div>
                <div class="col-6">
                    <b-form-group label="View Stats Over">
                        <b-form-select v-model="filter_period" @change="getAnalysisData">
...
<script>
    ...
    export default {
        ...
        methods: {
            getAnalysisData() {
                axios.get(
                    this.route('api.admin.activity.analysis-data', {filterDate: this.filter_period})
                  ).then(response => {
...
#analysis-component .table tr:first-of-type td {
    font-weight: bold;
}
